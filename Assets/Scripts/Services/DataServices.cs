...
public static class DataServices
{
    ...
    public struct DeathPlayer_RequestBody
    {
        public string uuid;
        public float x;
        public float y;
    ...
    public struct Shoot_RequestBody
    {
        public string uuid;
        public float x;
        public float y;
    ...
    public static IEnumerator C_PlayerDiedDataPing(string uuid, float x, float y, Action OnSuccess = null, Action OnFail = null)
    {
        DeathPlayer_RequestBody requestBody = new DeathPlayer_RequestBody()
        {
            uuid = uuid,
            x = x,
            y = y,
        ...
        HTTPRequest request = new HTTPRequest(new Uri($"http://jamie-portfolio-nextjs-ybde9q-9f73ad-82-68-47-77.traefik.me/api/positions/death/"), HTTPMethods.Post)
        {
            UploadSettings = new Best.HTTP.Request.Settings.UploadSettings()
            {
                UploadStream = new MemoryStream(body),
    ...
    public static IEnumerator C_PlayerShootDataPing(string uuid, float x, float y, Action OnSuccess = null, Action OnFail = null)
    {
        Shoot_RequestBody requestBody = new Shoot_RequestBody()
        {
            uuid = uuid,
            x = x,
            y = y,
        ...
        HTTPRequest request = new HTTPRequest(new Uri($"http://jamie-portfolio-nextjs-ybde9q-9f73ad-82-68-47-77.traefik.me/api/positions/shooting/"), HTTPMethods.Post)
        {
            UploadSettings = new Best.HTTP.Request.Settings.UploadSettings()
            {
                UploadStream = new MemoryStream(body),
